 ...
 */
package biz.ritter.develop.cobol.oc;
...
/** Identify COBOL keyword, mnemonic, intrinsic function,... and define
 * formats for display.
 */
public class KeywordScanner extends RuleBasedScanner {
  ...
  private static void loadReservedKeywords () throws IOException {
    BufferedReader br = new BufferedReader(new InputStreamReader(KeywordScanner.class.getResourceAsStream("oc-reserved-1.1.0")));
  ...
  private static void loadInstrinsicFunctions () throws IOException {
    BufferedReader br = new BufferedReader(new InputStreamReader(KeywordScanner.class.getResourceAsStream("oc-intrinsic-1.1.0")));
